...
namespace UI.Bar.View.Concrete_Types.Filling_Bar
{
    [CreateAssetMenu(fileName = "Filling Bar View Settings",
        menuName = ScriptableObjectsMenuDirectories.ConcreteUISettingsDirectory + "Filling Bar View Settings", order = 0)]
    public class FillingBarSettings : ScriptableObject
    {
